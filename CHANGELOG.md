...
### Deployment
- **Деплой v1.18.0** на `sport-set.ru` — Angular собран, архив 9.3MB загружен, Docker-контейнеры перезапущены
- **Health:** `{"status":"ok"}` на порту 4000
- **Seed:** пропущен (данные уже есть — duplicate key на SP0001)
- **3 контейнера:** kppdf40-backend ✅, kppdf40-mongodb ✅, kppdf40-chromadb ✅
